...
function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-zinc-950">
      {/* Top Navigation Header */}
      <header className="sticky top-0 z-40 flex h-14 shrink-0 items-center justify-between border-b border-border/80 bg-background/95 px-4 backdrop-blur-md sm:h-16 sm:px-6 lg:px-10">
        <div className="flex items-center gap-3">
          ...
          >
            <img
              src="/logo-light.png"
              alt="NepaliMentor"
              className="h-7 w-auto max-w-[120px] object-contain sm:h-8 dark:hidden"
            />
            <img
              src="/logo.png"
              alt="NepaliMentor"
              className="hidden h-7 w-auto max-w-[120px] object-contain sm:h-8 dark:block"
            />
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <Link
            to="/"
            className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-border bg-card px-3 text-xs font-bold text-foreground shadow-2xs transition-colors hover:bg-muted"
          >
          ...
          {isAuthenticated ? (
            <Link
              to="/superadmin"
              className="inline-flex h-9 items-center rounded-lg border border-zinc-300 bg-gradient-to-b from-zinc-100 to-zinc-200/80 px-3.5 text-xs font-bold text-zinc-900 shadow-2xs transition-all hover:bg-zinc-900 hover:text-white dark:border-zinc-700 dark:bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900 dark:text-zinc-100 dark:hover:bg-white dark:hover:text-zinc-950"
            >
              Workspace
            </Link>
          ) : (
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-10 lg:py-18">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
            Have questions about courses, live workshops, or 1-on-1 mentorship?
            Our team is here to support your learning journey every step of the
            way.
          </p>
        </div>
